# Generated by Django 3.0.5 on 2020-09-11 15:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spacetimeChoice', models.CharField(choices=[('30', '30 seconds'), ('1', '1 minute'), ('2', '2 hours'), ('12', '12 hours'), ('24', '1 Day')], max_length=2)),
                ('sensorsChoice', multiselectfield.db.fields.MultiSelectField(choices=[('t', 'temperature'), ('c', 'proximity'), ('l', 'light'), ('p', 'pressure')], max_length=7)),
